...
check_auth();
rbac_require_from_matrix('department_head.risk.view', ['department_head', 'department_admin', 'admin', 'super_admin']);
...
<head>
    ...
    <title>Department Head - Risk Alerts</title>
...
<header class="nav" id="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="risk_alerts.php" class="active"><img src="../assets/images/admin/checking.png" class="nav-icon" alt="">Risk Alerts</a>
...
<section class="main-content">
    <div class="dash-header"><h1>Risk Alerts</h1><p>High-level oversight of delayed, overbudget, rejected, and low-progress projects.</p></div>
    <div class="pm-section card">
        <div class="table-wrap">
            <table class="table" id="dhRiskTable">
                <thead><tr><th>Project</th><th>Issue Type</th><th>Severity</th><th>Recommended Action</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
