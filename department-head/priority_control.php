...
check_auth();
rbac_require_from_matrix('department_head.priority.manage', ['department_head', 'department_admin', 'admin', 'super_admin']);
check_suspicious_activity();
if (!isset($_SESSION['employee_id'])) { header('Location: /department-head/index.php'); exit; }
...
<head>
    ...
    <title>Department Head - Priority Control</title>
...
<body data-page="priority-control">
...
<header class="nav" id="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="priority_control.php" class="active"><img src="../assets/images/admin/prioritization.png" class="nav-icon" alt="">Priority Control</a>
...
<section class="main-content">
    <div class="dash-header"><h1>Priority Control</h1><p>Set governance priority for approved projects.</p></div>
    <div class="pm-section card">
        <div id="dhFeedback" class="ac-c8be1ccb"></div>
        <div class="table-wrap">
            <table class="table" id="dhPriorityTable">
                <thead><tr><th>Code</th><th>Project</th><th>Status</th><th>Location</th><th>Current Priority</th><th>Set Priority</th><th>Actions</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
