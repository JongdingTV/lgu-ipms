...
check_auth();
rbac_require_from_matrix('department_head.decisions.view', ['department_head', 'department_admin', 'admin', 'super_admin']);
...
<head>
    ...
    <title>Department Head - Decision Logs</title>
...
<header class="nav" id="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="decision_logs.php" class="active"><img src="../assets/images/admin/person.png" class="nav-icon" alt="">Decision Logs</a>
    </div>
...
<section class="main-content">
    <div class="dash-header"><h1>Decision Logs</h1><p>Full audit trail of approvals, rejections, and priority changes.</p></div>
    <div class="pm-section card">
        <div class="pm-controls-wrapper">
            <div class="pm-controls dept-module-filters">
                <div class="filter-group"><label for="dhDecisionSearch">Search</label><input id="dhDecisionSearch" type="search" placeholder="Project code, name, decision"></div>
                <div class="filter-group"><label for="dhDecisionType">Decision</label><select id="dhDecisionType"><option value="">All</option><option value="approved">Approved</option><option value="rejected">Rejected</option><option value="priority_change">Priority Change</option></select></div>
                <div class="filter-group"><label for="dhDecisionDate">Date</label><input id="dhDecisionDate" type="date"></div>
                <div class="filter-group filter-actions"><button type="button" id="dhDecisionApply" class="dept-btn details">Apply</button></div>
            </div>
        </div>
        <div id="dhFeedback" class="ac-c8be1ccb"></div>
        <div class="table-wrap">
            <table class="table" id="dhDecisionTable">
                <thead><tr><th>Project</th><th>Decision</th><th>Notes</th><th>Date</th><th>Approved By</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
