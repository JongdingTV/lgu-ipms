...
<head>
    ...
    <title>Department Head Dashboard Overview</title>
...
<body>
    ...
    <header class="nav" id="navbar">
        ...
        <div class="nav-action-footer">
            <a href="/department-head/logout.php" class="btn-logout nav-logout">
            ...
            <div class="metric-card card" id="budgetCard" data-budget="<?php echo number_format($totalBudget, 2); ?>">
                ...
                <div class="metric-content">
                    ...
                    <div class="ac-9b373689">
                        <p class="metric-value ac-03320d86" id="budgetValue">PHP <?php echo number_format((float) $totalBudget, 2); ?></p>
                    </div>
