...
(function () {
  ...
  const isEngineer = path.includes('/engineer/') && !/\/engineer\/(index|forgot-password|change-password|logout)\.php$/i.test(path);
  ...
  function initTopSidebarToggle() {
    ...
    const applyResponsiveSidebarMode = () => {
      ...
      // Force sidebar to stay visible on all engineer submodules.
      document.body.classList.remove('sidebar-hidden');
      document.body.classList.remove('mobile-nav-open');
      localStorage.removeItem('ipms_engineer_sidebar_hidden');
    };
  ...
  function normalizeSidebarNavLinks() {
    ...
    const links = [
      ...
      { href: 'submissions_validation.php', label: 'Submissions for Validation', icon: '../assets/images/admin/check.png' },
      { href: 'site_reports.php', label: 'Site Reports', icon: '../assets/images/admin/chart.png' },
      { href: 'inspection_requests.php', label: 'Inspection Requests', icon: '../assets/images/admin/sandclock.png' },
      { href: 'issues_risks.php', label: 'Issues & Risks', icon: '../assets/images/admin/prioritization.png' },
  ...
  function initLogoutModal() {
    ...
    let nextUrl = '/engineer/logout.php';
    const close = () => {
    ...
    document.addEventListener('click', (e) => {
      ...
      nextUrl = link.getAttribute('href') || '/engineer/logout.php';
  ...
  function initTopUtilities() {
    ...
    const fetchNotifications = () => {
      const url = '/engineer/api.php?action=load_notifications';
