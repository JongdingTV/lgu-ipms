...
<div class="wrapper">
    <div class="card">
        ...
        <p class="subtitle">Secure access for LGU citizens.</p>
        <?php if ($showOtpForm && isset($_SESSION['pending_user'])): ?>
            <div style="background-color: #d4edda; border: 1px solid #c3e6cb; color: #155724; padding: 12px; border-radius: 6px; margin-bottom: 20px; display: flex; align-items: center; gap: 8px;">
                ...
                <span><strong>Verification Required!</strong> Enter the code sent to your email.</span>
            </div>
            <form method="post">
                <div class="input-box">
        ...
        <?php else: ?>
            <form method="post">
                ...
                <div style="text-align: center; margin-top: 12px;">
                    <a href="create.php" class="link">Create an account</a>
                </div>
            </form>
        <?php endif; ?>
        <?php if (isset($error)): ?>
