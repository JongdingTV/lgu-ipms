...
<body class="super-admin-theme">
    <header class="sidebar">
        ...
        <div class="nav-links">
            <a href="/super-admin/dashboard.php"><img src="../assets/images/admin/dashboard.png" class="nav-icon">Overview</a>
            ...
            <a href="/admin/dashboard.php"><img src="../assets/images/admin/monitoring.png" class="nav-icon">Admin Panel</a>
        </div>
    ...
    <section class="main-content">
        <div class="dash-header">
            ...
            <p>Create, update, secure, and remove employee/admin accounts.</p>
        </div>
