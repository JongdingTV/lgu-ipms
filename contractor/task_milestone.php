...
<head>
    ...
    <title>Contractor Task & Milestone - LGU IPMS</title>
...
<section class="main-content">
    <div class="dash-header">
        ...
        <p>Add and validate tasks/milestones per project.</p>
    </div>
...
(function () {
    ...
    function statusSelect(type, id, current) {
        ...
        return '<select data-type=\"' + type + '\" data-id=\"' + id + '\" class=\"contractor-select\">' + all.map(function (s) {
