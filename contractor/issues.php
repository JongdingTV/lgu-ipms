...
<header class="nav" id="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="issues.php" class="active"><img src="../assets/images/admin/notifications.png" class="nav-icon" alt="">Issues</a>
...
<section class="main-content" data-contractor-module data-module="issues" data-csrf="<?php echo htmlspecialchars((string)($csrfToken), ENT_QUOTES, 'UTF-8'); ?>">
