...
if (contractorForm && resetBtn && formMessage) {
            ...
            if (logoutBtn) {
                logoutBtn.onclick = function(e) {
                    ...
                    showConfirmation({
                        ...
                        cancelText: 'Cancel',
                        onConfirm: () => {
                            window.location.href = '/contractor/logout.php';
                        }
                    });
                    return false;
                };
...
(function () {
  ...
  function setupLogoutConfirmation() {
    ...
    let pendingUrl = '/contractor/logout.php';
    ...
    document.addEventListener('click', (e) => {
      ...
      pendingUrl = link.getAttribute('href') || '/contractor/logout.php';
      modal.classList.add('show');
      modal.style.cssText = '';
