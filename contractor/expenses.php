...
<head>
    ...
    <title>Expenses - Contractor</title>
...
<header class="nav" id="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="expenses.php" class="active"><img src="../assets/images/admin/budget.png" class="nav-icon" alt="">Expenses / Billing</a>
...
<section class="main-content" data-contractor-module data-module="expenses" data-csrf="<?php echo htmlspecialchars((string)($csrfToken), ENT_QUOTES, 'UTF-8'); ?>">
    <div class="dash-header"><h1>Expenses / Billing</h1><p>Submit project expenses and receipts for validation.</p></div>
    <div class="cm-card"><div class="cm-form"><select id="cmProject" class="cm-select"></select><input id="cmAmount" class="cm-input" type="number" min="0" step="0.01" placeholder="Amount"><input id="cmCategory" class="cm-input" placeholder="Category"><input id="cmReceipt" type="file" class="cm-input" accept=".pdf,.jpg,.jpeg,.png"><textarea id="cmDescription" class="cm-textarea full" placeholder="Description"></textarea><button id="cmSubmitExpense" class="cm-btn" type="button">Submit Expense</button></div><div id="cmFeedback" class="cm-feedback"></div></div>
    <div class="cm-card cm-table-wrap"><table class="cm-table"><thead><tr><th>Project</th><th>Amount</th><th>Category</th><th>Status</th><th>Date</th></tr></thead><tbody id="cmExpensesBody"><tr><td colspan="5">Loading...</td></tr></tbody></table></div>
</section>
