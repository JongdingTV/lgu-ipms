...
<header class="nav" id="navbar"><div class="nav-logo"><img src="../assets/images/icons/ipms-icon.png" alt="" class="logo-img"><span class="logo-text">IPMS Contractor</span></div>
