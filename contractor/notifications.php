...
rbac_require_from_matrix('contractor.notifications.read', ['contractor','admin','super_admin']);
...
<head>
    ...
    <title>Notifications - Contractor</title>
...
<header class="nav" id="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="notifications.php" class="active"><img src="../assets/images/admin/notifications.png" class="nav-icon" alt="">Notifications</a>
...
<section class="main-content" data-contractor-module data-module="notifications" data-csrf="<?php echo htmlspecialchars((string)($csrfToken), ENT_QUOTES, 'UTF-8'); ?>">
    <div class="dash-header"><h1>Notifications</h1><p>Submission results, message alerts, and reminders.</p></div>
    <div class="cm-card cm-table-wrap"><table class="cm-table"><thead><tr><th>Title</th><th>Details</th><th>Date</th></tr></thead><tbody id="cmNotificationsBody"><tr><td colspan="3">Loading...</td></tr></tbody></table></div>
</section>
