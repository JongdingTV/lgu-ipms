...
function dashboard_normalize_project_status(string $status): string
{
    ...
    $approval = ['for approval', 'pending', 'queued', 'planned', 'approved'];
    ...
    if (in_array($s, $approval, true)) return 'approval';
...
<body>
    ...
    <header class="nav" id="navbar">
        ...
        <div class="nav-logo">
            ...
            <div class="nav-item-group">
                <a href="#" class="nav-main-item" id="contractorsToggle"><img src="../assets/images/admin/contractors.png" class="nav-icon">Engineers/Contractors<span class="dropdown-arrow">&#9662;</span></a>
                    ...
                    if ($recentProjects && $recentProjects->num_rows > 0) {
                        while ($project = $recentProjects->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>PHP <?php echo number_format($project['budget'], 2); ?></td>
                            </tr>
                            <?php
                        }
                    } else {
