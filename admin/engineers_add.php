...
function eng_store_uploaded_file(array $file, string $docType): array
{
    ...
    $safeBase = preg_replace('/[^a-zA-Z0-9_-]+/', '_', pathinfo((string)($file['name'] ?? 'document'), PATHINFO_FILENAME));
...
<body class="engineer-registration-page">
    <main class="engineer-form-page">
        <header class="engineer-form-header">
            ...
            <a href="registered_contractors.php" class="engineer-back-link">Back to Registered Engineers</a>
        </header>
