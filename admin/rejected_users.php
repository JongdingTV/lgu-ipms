...
<head>
    ...
    <title>Rejected/Suspended Users - LGU IPMS</title>
...
<body data-page="applications-rejected">
...
<header class="nav" id="navbar">
    ...
    <div class="nav-links">
        ...
        <div class="nav-item-group">
            <a href="applications_engineers.php" class="nav-main-item" id="contractorsToggle"><img src="../assets/images/admin/person.png" class="nav-icon" alt="">Applications<span class="dropdown-arrow">&#9662;</span></a>
...
<section class="main-content">
    <div class="dash-header"><h1>Rejected / Suspended Users</h1><p>Denied and disabled applications for governance and reactivation review.</p></div>
    <div class="pm-section card">
        <div class="app-filter-grid">
            <div><label for="appRejectedType">Type</label><select id="appRejectedType"><option value="engineer">Engineers</option><option value="contractor">Contractors</option></select></div>
        </div>
        <div id="appFeedback" class="ac-c8be1ccb"></div>
        <div class="table-wrap"><table class="table app-main-table" id="rejectedTable"><thead><tr><th>Name / Company</th><th>Email</th><th>Specialization</th><th>Status</th><th>Reason</th><th>Submitted At</th></tr></thead><tbody></tbody></table></div>
    </div>
</section>
