...
<body>
    ...
    <section class="main-content">
        ...
        <div class="br-tabs" role="tablist" aria-label="Budget module sections">
            <button type="button" class="br-tab active" data-panel="budget" role="tab" aria-selected="true">1. Set Project Budget</button>
            <button type="button" class="br-tab" data-panel="sources" role="tab" aria-selected="false">2. Source Funds</button>
            <button type="button" class="br-tab" data-panel="expenses" role="tab" aria-selected="false">3. Track Expenses</button>
            <button type="button" class="br-tab" data-panel="overview" role="tab" aria-selected="false">4. Overview & Graph</button>
        </div>
        ...
        <div id="panel-overview" class="br-panel">
    ...
    (function () {
        ...
        function renderAll(stateArg) {
            ...
            renderSummary(state);
            if (activePanel === 'overview') drawChart(state);
        }
        ...
        function init() {
            ...
            window.addEventListener('resize', function () {
                if (activePanel === 'overview') drawChart(loadState());
            });
