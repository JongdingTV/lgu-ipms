...
<head>
    ...
    <title>Contractor Applications - LGU IPMS</title>
...
<body data-page="applications-contractors">
    ...
    <div class="nav-links">
        ...
        <div class="nav-item-group">
            ...
            <div class="nav-submenu" id="contractorsSubmenu">
                ...
                <a href="applications_contractors.php" class="nav-submenu-item active"><span class="submenu-icon">&#128203;</span><span>Contractor Applications</span></a>
            </div>
        </div>
...
<section class="main-content">
    <div class="dash-header"><h1>Contractor Applications</h1><p>Review, verify, approve, reject, and suspend contractor registrations.</p></div>
