...
<body>
    ...
    <section class="main-content">
        ...
        <div class="summary-section">
            <h2>Prioritization Summary</h2>
            <div class="summary">
                <div class="stat"><div id="totalInputs">0</div><small>Total Inputs</small></div>
                <div class="stat"><div id="criticalInputs">0</div><small>Critical</small></div>
                <div class="stat"><div id="highInputs">0</div><small>High Priority</small></div>
                <div class="stat"><div id="pendingInputs">0</div><small>Pending Review</small></div>
            </div>
        </div>
    </section>
    ...
    <script src="project-prioritization.js"></script>
</body>
</html>
